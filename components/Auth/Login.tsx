...
const Login: React.FC = () => {
    ...
    const handleGoogle = async () => {
        ...
        // Page will redirect, so no need to reset loading
    };
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
            <div className="w-full max-w-md">
                ...
                {/* Login Card */}
                <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800 rounded-[40px] p-8 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        >
                            {loading ? 'A Entrar...' : 'Acessar com Email'}
